...
public class TaskThreeFourLEDActivity extends Activity {
    private static final Logger LOGGER = LoggerFactory.getLogger(TaskThreeFourLEDActivity.class);
    ...
    protected void onUsbPermissionFailed() {
        PendingIntent pendingIntent = PendingIntent.getBroadcast(
                edu.buffalo.tablecloth.view.TaskThreeFourLEDActivity.this, 0, new Intent(TableclothService.ACTION_USB_PERMISSION_REQUEST), 0);
    ...
    protected void onReceivedData(@Receiver.Extra(TableclothService.EXTRA_DATA) int[] pressures) {
        ...
        for (int i=0;i<384;i++) {
            if (pressures[i] > 1) {
                if (i==198 || i==199 || i==214 || i==215 ||    //Bottom right
                     i==196 || i==197 || i==212 || i==213 ||   //Top right
                        i==164 || i==165 || i==180 || i==181 ||  //Top left
                        i==166 || i==167 || i==182 || i==183 )    //Bottom left
                    pressureSensed = true;
                break;
            }
        }
